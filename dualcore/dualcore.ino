...
void SD_init(){
  ...
  //20Mhz, default 40Mhz gak work di esp32s3 ubah klo lu pake yg lain
  if(!SD_MMC.begin("/sdcard", true, false, 20000, 5)){
    Serial.println("Card Mount Failed");
    return;
  }
  else{//GAK PAKE EEPROM BIAR EEPROM AWET, tracker nama pake file aja
...
#include "driver/temp_sensor.h" //SENSOR SUHU
...
//ALL TASK!!!
void initTempSensor(){//SENSOR SUHU
